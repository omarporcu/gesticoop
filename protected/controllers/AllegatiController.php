...
class AllegatiController extends Controller
{
	...
	public function actionIndex()
	{
		...
		if(isset($_GET['Allegati']))
			$model->attributes=$_GET['Allegati'];
	...
	{
		$model=Allegati::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Allegati $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='allegati-form')
		{
