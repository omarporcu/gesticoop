...
class AnagraficaController extends Controller
{
	...
	public function actionDelete($id)
	{
		...
		if(!isset($_GET['ajax']))
			$this->redirect(isset($_POST['returnUrl']) ? $_POST['returnUrl'] : array('anagrafica/index'));
	}
...
/*	public function actionIndex()
	{
		$dataProvider=new CActiveDataProvider('Anagrafica');
...
//	public function actionAdmin()
	public function actionIndex()
	{
		$model=new Anagrafica('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Anagrafica']))
			$model->attributes=$_GET['Anagrafica'];
	...
	{
		$model=Anagrafica::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Anagrafica $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='anagrafica-form')
		{
