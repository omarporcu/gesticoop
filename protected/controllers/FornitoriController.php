...
class FornitoriController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['Fornitori'];
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['Fornitori']))
		{
			$_POST['Fornitori']['logo'] = $model->logo;		
			$model->attributes=$_POST['Fornitori'];
			if($model->save())
			{
...
/*	public function actionIndex()
	{
		$dataProvider=new CActiveDataProvider('Fornitori');
...
//	public function actionAdmin()
	public function actionIndex()
	{
		$model=new Fornitori('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Fornitori']))
			$model->attributes=$_GET['Fornitori'];
	 ...
	 * @param Fornitori $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='fornitori-form')
		{
