...
/**
 * This is the model class for table "tbl_fornitori".
 *
 * The followings are the available columns in table 'tbl_fornitori':
 * @property integer $id
 ...
 */
class Fornitori extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return Fornitori the static model class
	 */
